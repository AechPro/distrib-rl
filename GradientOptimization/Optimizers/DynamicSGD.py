import numpy as np
from GradientOptimization.Optimizers import GradientOptimizer
from Utils import MathHelpers as math
...
class DynamicSGD(GradientOptimizer):
    ...
    def compute_update_step(self, gradient):
        ...
        if self.omega is not None:
            ...
            modifier = math.apply_affine_map(w, from_min=self.omega_min, from_max=self.omega_max,
                                                to_min=self.min_update_scale, to_max=self.max_update_scale)
        else:
