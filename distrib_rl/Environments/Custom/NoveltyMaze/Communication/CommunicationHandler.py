from distrib_rl.Environments.Custom.NoveltyMaze.Communication import Message, CommunicationExceptionHandler
...
class CommunicationHandler(object):
    ...
    def receive_message(self, header=None, num_attempts=100):
        ...
        for i in range(num_attempts):
            try:
                code, msg_bytes = win32file.ReadFile(self._pipe, CommunicationHandler.NOVELTY_MAZE_DEFAULT_PIPE_SIZE)
            ...
            if header is None or header == m.header:
                ...
                data = win32pipe.PeekNamedPipe(self._pipe, CommunicationHandler.NOVELTY_MAZE_DEFAULT_PIPE_SIZE)
                if data[0] == b'':
                    break
    ...
    def open_pipe(self, pipe_name=None, num_allowed_instances=1):
        ...
        self._pipe = win32pipe.CreateNamedPipe(pipe_name,
                                               ...
                                               CommunicationHandler.NOVELTY_MAZE_DEFAULT_PIPE_SIZE, 0, None)
