...
def _build_optimizer(cfg_section, policy, device):
    ...
    if t == "dsgd":
        from distrib_rl.gradient_optimization.optimizers import DynamicSGD

        return DynamicSGD(policy, **kwargs)

    elif t == "adam":
        from distrib_rl.gradient_optimization.optimizers import Adam
        ...
        from distrib_rl.gradient_optimization.optimizers import TorchWrapper
