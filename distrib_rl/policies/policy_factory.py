...
def _get_model_object(policy_type, action_type):
    ...
    if pt in ("rnn", "recurrent", "rec", "lstm", "gru"):
        ...
        if at == "discrete":
            from distrib_rl.policies.feed_forward import DiscreteFF

            return DiscreteFF
        elif at == "continuous":
            from distrib_rl.policies.feed_forward import ContinuousFF

            return ContinuousFF
        elif at == "multi_discrete" or at == "multidiscrete":
            from distrib_rl.policies.feed_forward import MultiDiscreteFF
