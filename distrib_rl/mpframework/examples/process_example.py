"""
    File name: process_example.py
    Author: Matthew Allen

    Description:
        This file contains an example for how to create a Process object and interface with it from
        the main process.
"""
import time

from distrib_rl.mpframework import Process, ProcessHandler
...
class ExampleProcess(Process):
    ...
    def step(self):
        # This gets called repeatedly on a loop by Process.
        self._data += 10
